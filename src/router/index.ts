...
router.beforeEach((to: ToRouteType, _from, next) => {
  ...
  //TODO 这里正常登录但是用户信息为空,是storageSession的问题吗？
  const userInfo = storageSession().getItem<TokenDTO>(userKey)?.currentUser;
  // console.log("user-info", storageLocal().getItem<TokenDTO>(tokenKey));
